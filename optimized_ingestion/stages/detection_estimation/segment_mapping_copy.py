...
from typing import List, NamedTuple, Tuple, Union, Dict, Any
import sys
...
MOCK_TRAJECTORY_1 =  [(283.0846066442669, 666.7491273579125), (285.172896432793, 667.3038603361285), (285.6108780172807, 667.4816783130578), (286.49231848729215, 667.8555318810955), (286.69873408200885, 668.1557005634678), (286.7617734958426, 668.3446583223605), (287.75997918450804, 668.6727805588818), (288.32674979865317, 669.1139685639446), (288.7870219205495, 669.4723289966488), (289.33505400698033, 670.0422566701948), (290.0360237030085, 670.5852782887335), (290.62674451555125, 670.9126038126167), (291.11704157755133, 671.4289645524376), (291.64552685759844, 671.9710014355088), (292.0976260152118, 672.1924095331576), (292.63248887319617, 672.731433281764), (293.51859303073593, 673.1853287882683), (293.39652752177375, 673.5675115914381), (294.11481695395264, 674.0023711893672), (294.7081375389355, 674.46143835816), (295.09236330112896, 674.6479405591296), (295.6775535942427, 675.1078831818027), (296.1442299254093, 675.5772944619898), (296.4367590687299, 675.7935008132264), (296.98141357738336, 676.2140190500216), (297.50015259460827, 676.6209191360615), (297.77507763274656, 676.8293630555318), (298.05147755824004, 677.3445639128774), (298.62927259499463, 677.5957762726077), (298.8549349741779, 677.9629937846075), (299.2451216171339, 678.3526666318148), (299.7266493791718, 678.7050339080585), (299.8578164297705, 678.8966794448899), (300.007765482301, 679.1142470556196), (300.2842760723128, 679.2194852575636), (300.3830088096315, 679.2876952100654), (300.6268683857484, 679.3898072086934), (300.17824696644306, 680.5210956148387), (299.78409993939874, 681.351686684353), (299.8011120576228, 681.699853465654), (287.08564229362344, 673.0073214932926), (286.2671291994167, 672.2976610775422), (281.1492066279918, 666.7140135468263), (281.02454404579873, 666.4158229224672)]
...
MOCK_TRAJECTORY_2 = [(298.63457985964493, 681.767738325874), (298.2382593594731, 681.2722349144998), (298.3039282879353, 680.9238801074249), (297.6293759465963, 680.7990400168155), (297.1944988936091, 680.2758597213607), (297.0627254905734, 680.1894140902444), (296.6016402400178, 680.3271301974929), (296.2998082299628, 680.1496631473874), (293.9346735159379, 678.593169987175), (293.8356598335076, 678.2343003460653), (293.41934652178776, 678.1410114143184), (292.99794806485886, 677.565048635977), (292.2810387002316, 677.1262247046877), (291.527286650631, 677.0116614549413), (290.1083316317138, 675.986276421192), (288.3807663609664, 674.5653261034836), (288.1401162244675, 674.2312819842657), (287.264766202083, 673.6911847346877), (286.6788095262505, 673.1260958921275), (285.899106808267, 672.077772083972), (285.032833143835, 671.521062758076), (284.8763784447907, 671.2255417540454), (284.49054852461546, 670.5726813821084), (283.8683540473013, 669.9580284054523), (283.6303330766203, 669.6013834258588), (282.34977543060177, 668.9386741157831), (281.7512921433899, 668.328294226094), (281.11403486591996, 668.1135729672671), (280.61957617954664, 667.8012709672904), (280.0421201249558, 667.4168029870596), (278.7340459957884, 667.451875402771), (286.296485069503, 667.7184843732431), (287.3393035121849, 668.2484634407851), (287.7642995690597, 668.5847349908024), (288.3413290666149, 668.7588743343475), (289.32515639606646, 669.8266097072657), (289.5682065713635, 670.157956378832), (291.35631318481023, 671.3196672951502), (291.5771823146549, 671.6266175304976), (292.9646614036655, 673.0961976714054), (293.63206145801774, 673.6087375026345), (294.3252749134875, 674.1582064034811), (294.70264974063696, 674.3369314828236), (295.3141715168099, 674.824857526736), (295.83724784828956, 675.3493689155653)]
...
def find_segment_dwithin(start_segment: "AnnotatedSegment",
                         view_distance=100) -> "List[SegmentPolygonWithHeading]":
...
def construct_mapping(
    ...
    if contains_ego or (len(keep_cam_segment_point) > 2
                        and Polygon(tuple(keep_cam_segment_point)).area > 200):
...
def visualization(test_img_path: str, test_config: Dict[str, Any], mapping: Tuple):
    ...
    for _, road_segment_info in mapping:
        ...
        if segmentlines is not None:
            [axs.plot([p[0] for p in tuple(segmentline.coords)], [p[1] for p in tuple(segmentline.coords)], 
                        color='black', marker='o', markersize=2)
                for segmentline in segmentlines if segmentline is not None]
        i += 1
    ...
    for segmentid in segmentids:
        ...
        if road_segment_info is None:
            for test_segment in result:
                ...
                road_segment_info = RoadSegmentInfo(
                    segmentid, segmentpolygon, [segmentline], segmenttype, [segmentheading], None, False, None)
        xs = [point[0] for point in road_segment_info.segment_polygon.exterior.coords]
        ys = [point[1] for point in road_segment_info.segment_polygon.exterior.coords]
        segmentid = road_segment_info.segment_id
        segmenttype = road_segment_info.segment_type
