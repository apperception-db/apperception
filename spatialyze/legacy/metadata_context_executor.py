...
from spatialyze.data_types.views import View, metadata_view
from spatialyze.legacy.metadata_context import (
    Aggregate,
    Column,
    Filter,
    MetadataContext,
...
from spatialyze.legacy.metadata_util import common_aggregation
