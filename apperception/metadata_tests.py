...
class TestStringMethods(unittest.TestCase):
	...
	def test_commands(self):
		...
		test_executor.context(test_context.get_geo().interval('0001-01-01 00:00:00','9999-12-31 23:59:59.999999'))
		print(test_executor.execute())
		print("------------------------------------")
	...
	def test_usecases(self):
		...
		filtered_world = test_context.predicate(lambda obj:obj.object_type == "car").predicate(lambda obj:obj.location in volume, {"volume":volume})
		...
		entire_video = test_context.predicate(lambda obj: obj.object_id in id_array, {"id_array":id_array}).get_columns(primarykey, geometry, time)
